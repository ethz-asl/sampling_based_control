...
const mppi::observation_t PandaMobileDynamics::get_state() const {
  return x_;
}

void PandaMobileDynamics::reset(const mppi::observation_t& x) {
  x_ = x;
}

mppi::input_t PandaMobileDynamics::get_zero_input(
