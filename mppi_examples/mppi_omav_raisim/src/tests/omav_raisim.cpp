...
int main(int argc, char** argv) {
    ...
    // activate raisim simulatro
    std::string activation_file;
    nh.param<std::string>("activation_file", activation_file, "/home/studigem/.raisim/activation.raisim");
    ...
    for (size_t i = 0; i < loopN; i++) {
        ...
        ROS_INFO_STREAM_THROTTLE(1.0, "OMAV state is: "
