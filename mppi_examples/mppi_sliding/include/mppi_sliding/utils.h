...
#define NAMED_LOG_INFO(...) manipulation_panda::namedLog(LogType::INFO, __PRETTY_FUNCTION__, __VA_ARGS__)
#define NAMED_LOG_WARN(...) manipulation_panda::namedLog(LogType::WARN, __PRETTY_FUNCTION__, __VA_ARGS__)
#define NAMED_LOG_ERROR(...) manipulation_panda::namedLog(LogType::ERROR, __PRETTY_FUNCTION__, __VA_ARGS__)
